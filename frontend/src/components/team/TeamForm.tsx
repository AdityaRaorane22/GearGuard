    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl bg-white border-slate-200">
        ...
        <form onSubmit={onSubmit} className="space-y-4 mt-2">
          ...
          {/* Specialization */}
          <div className="flex flex-col">
            <label className="text-xs text-slate-500 mb-1">Specialization</label>
            <input
          ...
          {/* Members Selection */}
          <div className="flex flex-col">
            <label className="text-xs text-slate-500 mb-2">Team Members</label>
            ...
            <div className="mb-3 flex flex-wrap gap-2">
              {selectedMembers.map((member) => (
                <div
                  key={member.id}
                  className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-200 text-blue-700"
                >
